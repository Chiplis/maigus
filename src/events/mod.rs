...
//!
//! ```ignore
//! use maigus::events::{Event, EventContext};
//! use maigus::event_processor::process_trait_event;
//!
...
//!
//! ```ignore
//! use maigus::events::{ReplacementMatcher, EventContext, GameEventType, EventKind, downcast_event, DamageEvent};
//!
//! #[derive(Debug, Clone)]
