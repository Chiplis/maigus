...
export default function SelectObjectsDecision({
  ...
  useEffect(() => {
    ...
    window.addEventListener("maigus:select-object-choice", onExternalObjectChoice);
    return () => {
      window.removeEventListener("maigus:select-object-choice", onExternalObjectChoice);
    };
